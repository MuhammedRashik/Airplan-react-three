...
import { Airplane } from "./Airplaine";
import { Background } from "./Baground";
    ...
    return [
      {
        ...
        subtitle: `Welcome to RAZIK'S WORLD,
  ...
  return useMemo(
    () => (
      <>
        ...
        {/* <OrbitControls /> hide this for donot want to zoom in and zoom out */}
